...
# 获取预训练模型的参数
pretrained_dict = {k: v for k, v in pretrain_model.items() if k not in del_list}
...
# 解冻五个全连接层：
layers = [googlenet_base.aux1.fc1, googlenet_base.aux1.fc2, googlenet_base.aux2.fc1, googlenet_base.aux2.fc2,
          googlenet_base.fc]
for layer in layers:
